...
const data = [
    {id: 1, icon: <SiAdobexd />, title: 'UI/UX', desc: 'My designs are modern and intuitive. I use industry-standard rules to make sure your users have fun using your product.'},
